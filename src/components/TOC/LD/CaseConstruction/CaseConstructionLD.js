...
class CaseConstructionLD extends React.Component {
    render() {
        return (
            <main className='body'>
                ...
                <Accordion>
                    <AccordionItem title='Framework'>
                        <p style={{padding : '1rem'}}>Your framework is your value and value criterion and sets up how the round should be evaluated.  Do we care more about intentions, consequences, or following contracts?  Framework also should explain why we care about those things.</p>
                    </AccordionItem>
               ...
               <h3>2. Efficiency of Argument</h3>
                ...
                <p><strong>Example: </strong>Framework -Util</p>
                <img src={Tricks2} height='60%' width='60%' alt='tricks2' border='2'/>
                <p>In the above example, Cummiskey explains that Utilitarianism is the only way to value the inherent equality of persons.  If people are indeed equal, saving three people is more valuable than saving one.  On the surface this looks like just a justification for Util.  But this warrant actually also functions as offense against other frameworks.  It basically says ANY framework that isn’t Util is a violation of human equality so it should be discarded.</p>
                <p>Why is it advantageous to give your warrants the ability to function as offense? For one, it follows the principle of case optimization and time efficiency.  On the other hand, it also exploits debater conditioning.  Debaters aren’t usually trained to look for arguments within the warrant of a contention, they usually place the most importance on evaluating the claim and impact.  So allowing your warrants to function as arguments too means a lot of good points will fly under your opponent’s radar.</p>
            </main>
        )
    }
}

export default CaseConstructionLD;